...
import { SplitColumnLayoutComponent } from './sections/splitColumnLayout/splitColumnLayout.component';
...
const appRoutes: Routes = [
  ...
  { path: 'splitColumnLayout', component: SplitColumnLayoutComponent },
